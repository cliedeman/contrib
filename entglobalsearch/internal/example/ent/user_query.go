...
import (
	...
	"entgo.io/contrib/entglobalsearch/internal/example/ent/predicate"
...
type UserQuery struct {
	...
	globalPredicate predicate.User
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if uq.globalPredicate != nil {
		originalFilters := _spec.Predicate
		_spec.Predicate = func(s *sql.Selector) {
			s1 := s.Clone().SetP(nil)
			if originalFilters != nil {
				originalFilters(s1)
			}
			uq.globalPredicate(s1)
			s.Where(s1.P())
		}
	}
